...
exports.ExampleWithoutInternalToJSON = exports.ExampleWithoutInternalFromJSONTyped = exports.ExampleWithoutInternalFromJSON = exports.instanceOfExampleWithoutInternal = void 0;
/**
 * Check if a given object implements the ExampleWithoutInternal interface.
 */
function instanceOfExampleWithoutInternal(value) {
    if (!('id' in value))
        return false;
    if (!('slug' in value))
        return false;
...
exports.instanceOfExampleWithoutInternal = instanceOfExampleWithoutInternal;
function ExampleWithoutInternalFromJSON(json) {
    return ExampleWithoutInternalFromJSONTyped(json, false);
}
exports.ExampleWithoutInternalFromJSON = ExampleWithoutInternalFromJSON;
function ExampleWithoutInternalFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.ExampleWithoutInternalFromJSONTyped = ExampleWithoutInternalFromJSONTyped;
function ExampleWithoutInternalToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.ExampleWithoutInternalToJSON = ExampleWithoutInternalToJSON;
