 ...
 *
 * @export
 * @interface ExampleWithoutRequired
 */
export interface ExampleWithoutRequired {
    /**
     * Unique ID of the object
     * @type {string}
     * @memberof ExampleWithoutRequired
     */
    id: string;
    /**
     *
 ...
 */
export declare function instanceOfExampleWithoutRequired(value: object): boolean;
export declare function ExampleWithoutRequiredFromJSON(json: any): ExampleWithoutRequired;
export declare function ExampleWithoutRequiredFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExampleWithoutRequired;
export declare function ExampleWithoutRequiredToJSON(value?: ExampleWithoutRequired | null): any;
