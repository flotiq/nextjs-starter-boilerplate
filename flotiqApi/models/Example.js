...
exports.ExampleToJSON = exports.ExampleFromJSONTyped = exports.ExampleFromJSON = exports.instanceOfExample = void 0;
 ...
 */
function instanceOfExample(value) {
    if (!('id' in value))
        return false;
    if (!('slug' in value))
        return false;
...
exports.instanceOfExample = instanceOfExample;
function ExampleFromJSON(json) {
    return ExampleFromJSONTyped(json, false);
}
exports.ExampleFromJSON = ExampleFromJSON;
function ExampleFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.ExampleFromJSONTyped = ExampleFromJSONTyped;
