 ...
 *
 * @export
 * @interface ExampleWithoutInternal
 */
export interface ExampleWithoutInternal {
    /**
     * Unique ID of the object
     * @type {string}
     * @memberof ExampleWithoutInternal
     */
    id: string;
    /**
     *
 ...
 */
export declare function instanceOfExampleWithoutInternal(value: object): boolean;
export declare function ExampleWithoutInternalFromJSON(json: any): ExampleWithoutInternal;
export declare function ExampleWithoutInternalFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExampleWithoutInternal;
export declare function ExampleWithoutInternalToJSON(value?: ExampleWithoutInternal | null): any;
