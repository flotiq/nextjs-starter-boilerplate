 ...
 */
export declare function instanceOfExampleList(value: object): boolean;
export declare function ExampleListFromJSON(json: any): ExampleList;
export declare function ExampleListFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExampleList;
export declare function ExampleListToJSON(value?: ExampleList | null): any;
