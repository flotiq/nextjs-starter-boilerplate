...
exports.ExampleVersionsListToJSON = exports.ExampleVersionsListFromJSONTyped = exports.ExampleVersionsListFromJSON = exports.instanceOfExampleVersionsList = void 0;
var VersionItem_1 = require("./VersionItem");
/**
 * Check if a given object implements the ExampleVersionsList interface.
 */
function instanceOfExampleVersionsList(value) {
...
exports.instanceOfExampleVersionsList = instanceOfExampleVersionsList;
function ExampleVersionsListFromJSON(json) {
    return ExampleVersionsListFromJSONTyped(json, false);
}
exports.ExampleVersionsListFromJSON = ExampleVersionsListFromJSON;
function ExampleVersionsListFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.ExampleVersionsListFromJSONTyped = ExampleVersionsListFromJSONTyped;
function ExampleVersionsListToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.ExampleVersionsListToJSON = ExampleVersionsListToJSON;
