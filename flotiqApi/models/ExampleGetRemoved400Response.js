...
exports.ExampleGetRemoved400ResponseToJSON = exports.ExampleGetRemoved400ResponseFromJSONTyped = exports.ExampleGetRemoved400ResponseFromJSON = exports.instanceOfExampleGetRemoved400Response = void 0;
/**
 * Check if a given object implements the ExampleGetRemoved400Response interface.
 */
function instanceOfExampleGetRemoved400Response(value) {
    return true;
}
exports.instanceOfExampleGetRemoved400Response = instanceOfExampleGetRemoved400Response;
function ExampleGetRemoved400ResponseFromJSON(json) {
    return ExampleGetRemoved400ResponseFromJSONTyped(json, false);
}
exports.ExampleGetRemoved400ResponseFromJSON = ExampleGetRemoved400ResponseFromJSON;
function ExampleGetRemoved400ResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.ExampleGetRemoved400ResponseFromJSONTyped = ExampleGetRemoved400ResponseFromJSONTyped;
function ExampleGetRemoved400ResponseToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.ExampleGetRemoved400ResponseToJSON = ExampleGetRemoved400ResponseToJSON;
