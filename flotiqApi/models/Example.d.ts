 ...
 */
export declare function instanceOfExample(value: object): boolean;
export declare function ExampleFromJSON(json: any): Example;
export declare function ExampleFromJSONTyped(json: any, ignoreDiscriminator: boolean): Example;
export declare function ExampleToJSON(value?: Example | null): any;
