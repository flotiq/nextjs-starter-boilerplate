...
exports.ExampleListToJSON = exports.ExampleListFromJSONTyped = exports.ExampleListFromJSON = exports.instanceOfExampleList = void 0;
var Example_1 = require("./Example");
/**
 * Check if a given object implements the ExampleList interface.
 */
function instanceOfExampleList(value) {
...
exports.instanceOfExampleList = instanceOfExampleList;
function ExampleListFromJSON(json) {
    return ExampleListFromJSONTyped(json, false);
}
exports.ExampleListFromJSON = ExampleListFromJSON;
function ExampleListFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : (json['data'].map(Example_1.ExampleFromJSON)),
    };
}
exports.ExampleListFromJSONTyped = ExampleListFromJSONTyped;
function ExampleListToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
        ...
        'data': value['data'] == null ? undefined : (value['data'].map(Example_1.ExampleToJSON)),
    };
}
exports.ExampleListToJSON = ExampleListToJSON;
