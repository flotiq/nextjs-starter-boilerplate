...
exports.ExampleWithoutRequiredToJSON = exports.ExampleWithoutRequiredFromJSONTyped = exports.ExampleWithoutRequiredFromJSON = exports.instanceOfExampleWithoutRequired = void 0;
var AbstractContentTypeSchemaDefinitionInternal_1 = require("./AbstractContentTypeSchemaDefinitionInternal");
/**
 * Check if a given object implements the ExampleWithoutRequired interface.
 */
function instanceOfExampleWithoutRequired(value) {
    if (!('id' in value))
        return false;
    return true;
}
exports.instanceOfExampleWithoutRequired = instanceOfExampleWithoutRequired;
function ExampleWithoutRequiredFromJSON(json) {
    return ExampleWithoutRequiredFromJSONTyped(json, false);
}
exports.ExampleWithoutRequiredFromJSON = ExampleWithoutRequiredFromJSON;
function ExampleWithoutRequiredFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.ExampleWithoutRequiredFromJSONTyped = ExampleWithoutRequiredFromJSONTyped;
function ExampleWithoutRequiredToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.ExampleWithoutRequiredToJSON = ExampleWithoutRequiredToJSON;
