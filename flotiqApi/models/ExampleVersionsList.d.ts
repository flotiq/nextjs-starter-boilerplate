 ...
 *
 * @export
 * @interface ExampleVersionsList
 */
export interface ExampleVersionsList {
    /**
     *
     * @type {number}
     * @memberof ExampleVersionsList
     */
    total_count: number;
    /**
     *
 ...
 */
export declare function instanceOfExampleVersionsList(value: object): boolean;
export declare function ExampleVersionsListFromJSON(json: any): ExampleVersionsList;
export declare function ExampleVersionsListFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExampleVersionsList;
export declare function ExampleVersionsListToJSON(value?: ExampleVersionsList | null): any;
