...
import type { BatchResponseSuccess, ExampleBatchDelete200Response, Tag, TagList, TagVersionsList, TagWithoutInternal, TagWithoutRequired } from '../models/index';
...
export declare class TagInternalAPI extends runtime.BaseAPI {
     ...
     */
    batchDeleteRaw(requestParameters: TagInternalAPIBatchDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ExampleBatchDelete200Response>>;
    /**
     * Allows you to delete up to 100 objects of Tag (internal) type. <br />Request body accepts an array of content object IDs that are to be deleted.<br />
     * Delete a batch of _tag objects
     */
    batchDelete(requestParameters?: TagInternalAPIBatchDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ExampleBatchDelete200Response>;
    /**
