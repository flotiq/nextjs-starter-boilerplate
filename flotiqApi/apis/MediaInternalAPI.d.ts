...
import type { BatchResponseSuccess, ExampleBatchDelete200Response, Media, MediaList, MediaVersionsList, MediaWithoutInternal, MediaWithoutRequired } from '../models/index';
...
export declare class MediaInternalAPI extends runtime.BaseAPI {
     ...
     */
    batchDeleteRaw(requestParameters: MediaInternalAPIBatchDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ExampleBatchDelete200Response>>;
    /**
     * Allows you to delete up to 100 objects of Media (internal) type. <br />Request body accepts an array of content object IDs that are to be deleted.<br />
     * Delete a batch of _media objects
     */
    batchDelete(requestParameters?: MediaInternalAPIBatchDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ExampleBatchDelete200Response>;
    /**
